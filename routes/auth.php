...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/teste', function () {return view('teste'); })->name('teste')->middleware('checkrole:admin');
    Route::get('listar', [listarUsuariosController::class, 'listar'])->name('listar')->middleware('checkrole:admin');



    Route::get('editar', [listarUsuariosController::class, 'editar'])->name('usuarios.edit');
    Route::delete('excluir/{id}', [listarUsuariosController::class, 'excluir'])->name('usuarios.destroy');
